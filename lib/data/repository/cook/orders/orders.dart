...
class CookOrdersRepositoryImpl extends CookOrdersRepository {
  // @override
  ...
  Future<Either<dynamic, dynamic>> getOrders() async{
    return await sl<CookOrdersFirebaseServise>().getOrders();
  }

  @override
  Future<Either<dynamic, dynamic>> updateStatus(UpdateStatusModel cradentials) async{
        return await sl<CookOrdersFirebaseServise>().updateStatus(cradentials);
